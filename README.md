...
This is an image that is created from a gray-scale image and calculates how often a pixel with a specific gray-level occurs either horizontally, vetically, or diagonally to adjacent pixels.